...
public class UsersActivity extends AppCompatActivity {
    ...
    public static class UserViewHolder extends RecyclerView.ViewHolder{
        ...
        public  void setDisplayName(String name) {
            TextView usersNameView=(TextView)view.findViewById(R.id.single_name_text);
            usersNameView.setText(name);
        }


        public void setDisplayStatus(String ststus) {
            TextView userStatusView=(TextView)view.findViewById(R.id.single_status_text);
            userStatusView.setText(ststus);
        }

        public void setThumbImage(String thumb_image) {
            CircleImageView circleImageView=(CircleImageView)view.findViewById(R.id.single_imageView);
